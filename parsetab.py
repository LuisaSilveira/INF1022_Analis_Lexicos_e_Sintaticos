...
_lr_productions = [
  ...
  ('obsact -> SE obs ENTAO cmd SENAO cmd','obsact',6,'p_obsact_if_else','parser_c.py',111),
  ('obs -> NAMEDEVICE oplogic var','obs',3,'p_obs','parser_c.py',126),
  ('obs -> NAMEDEVICE oplogic var E_LOGICO obs','obs',5,'p_obs_multiple','parser_c.py',129),
  ('oplogic -> GT','oplogic',1,'p_oplogic_gt','parser_c.py',134),
  ('oplogic -> LT','oplogic',1,'p_oplogic_lt','parser_c.py',135),
  ('oplogic -> MAIOR_IGUAL','oplogic',1,'p_oplogic_ge','parser_c.py',136),
  ('oplogic -> MENOR_IGUAL','oplogic',1,'p_oplogic_le','parser_c.py',137),
  ('oplogic -> IGUAL_IGUAL','oplogic',1,'p_oplogic_eq','parser_c.py',138),
  ('oplogic -> DIFERENTE','oplogic',1,'p_oplogic_ne','parser_c.py',139),
  ('act -> action NAMEDEVICE','act',2,'p_act_action','parser_c.py',141),
  ('act -> ENVIAR ALERTA ( MSG ) NAMEDEVICE','act',6,'p_act_alerta_msg','parser_c.py',144),
  ('act -> ENVIAR ALERTA ( MSG , NAMEDEVICE ) NAMEDEVICE','act',8,'p_act_alerta_obs','parser_c.py',147),
  ('act -> ENVIAR ALERTA ( MSG ) PARA TODOS : dev_list','act',9,'p_act_broadcast','parser_c.py',150),
  ('act -> ENVIAR ALERTA ( MSG , NAMEDEVICE ) PARA TODOS : dev_list','act',11,'p_act_broadcast_with_obs','parser_c.py',153),
  ('dev_list -> NAMEDEVICE , dev_list','dev_list',3,'p_dev_list_multiple','parser_c.py',157),
  ('dev_list -> NAMEDEVICE','dev_list',1,'p_dev_list_single','parser_c.py',158),
  ('action -> LIGAR','action',1,'p_action_ligar','parser_c.py',160),
  ('action -> DESLIGAR','action',1,'p_action_desligar','parser_c.py',161),
]
